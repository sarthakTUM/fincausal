...
from fnp.fincausal.model.sklearn_model import TfIdfWordCharVectorizerXgbClassifier
...
fincausal_task1_model_path = Path('/media/sarthak/HDD/data_science/fnp_resources/fincausal_t1_models/90_1/output/best_model')
...
# 5. Create a Model
classifier = TfIdfWordCharVectorizerXgbClassifier(output_dir=fincausal_task1_model_path,
                                                  reload=False)

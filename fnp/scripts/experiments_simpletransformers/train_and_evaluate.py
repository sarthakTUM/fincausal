...
simpletransformers_model = SimpleTransformersModel(
    model_type='bert',
    model_name_or_path='/media/sarthak/HDD/data_science/fnp_resources/pretrained_models/finbert_latest',
    output_dir=Path('/media/sarthak/HDD/data_science/fnp_resources/fincausal_t1_models/145_1'),
    class_weights=None)
...
simpletransformers_model = SimpleTransformersModel(
    model_type='bert',
    model_name_or_path=Path('/media/sarthak/HDD/data_science/fnp_resources/fincausal_t1_models/145_1/output/best_model'),
    output_dir=Path('/media/sarthak/HDD/data_science/fnp_resources/fincausal_t1_models/145_1/output/best_model'))
...
fincausal_task1_inference = FinCausalTask1Inference(
    model_path=Path('/media/sarthak/HDD/data_science/fnp_resources/fincausal_t1_models/145_1/output/best_model'),
    ...
    output_dir=Path('/media/sarthak/HDD/data_science/fnp_resources/fincausal_t1_models/145_1/output/best_model/inference')
)
